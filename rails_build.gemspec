...
Gem::Specification.new do |s|
  ...
  s.add_dependency "rails", "~> 5", ">= 5"

  #s.add_dependency "coerce", ">= 0.0.8"
  #s.add_dependency "fattr", ">= 2.3.0"
  #s.add_dependency "map", ">= 6.6.0"

  s.add_dependency "threadify", "~> 1.4", ">= 1.4.5"
  s.add_dependency "fattr", "~> 2.3", ">= 2.3.0"
  s.add_dependency "passenger", "~> 5.0", ">= 5.0.30"
  s.add_dependency "persistent_http", "~> 2.0", ">= 2.0.1"
